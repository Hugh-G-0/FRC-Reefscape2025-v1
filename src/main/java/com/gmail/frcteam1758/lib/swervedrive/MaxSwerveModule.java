...
public class MaxSwerveModule implements SwerveModule {
    ...
    public void run(SwerveModuleState p_state) {
        ...
        m_drvPID.setReference(p_state.speedMetersPerSecond, SparkMax.ControlType.kVelocity);
        m_strPID.setReference(p_state.angle.getRadians(), SparkMax.ControlType.kPosition);
    ...
    public void setDesiredState(SwerveModuleState desiredState) {
        ...
        m_drvPID.setReference(desiredState.speedMetersPerSecond, SparkMax.ControlType.kVelocity);
        m_strPID.setReference(desiredState.angle.getRadians(), SparkMax.ControlType.kPosition);
      }
